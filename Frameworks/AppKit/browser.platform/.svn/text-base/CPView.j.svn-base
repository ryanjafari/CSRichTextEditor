I;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;12;CPGeometry.ji;19;CPGraphicsContext.ji;13;CPResponder.ji;9;CPTheme.ji;18;_CPDisplayServer.jc;55788;
CPViewNotSizable=0;
CPViewMinXMargin=1;
...
var _c=_b.isa;
class_addMethods(_b,[new objj_method(sel_getUid("performKeyEquivalent:"),function(self,_cmd,_174){
with(self){
var _175=objj_msgSend(self,"subviews"),_176=objj_msgSend(_175,"count");
while(_176--){
if(objj_msgSend(_175[_176],"performKeyEquivalent:",_174)){
return YES;
}
}
return NO;
...
with(self){
var _17d=objj_msgSend(self,"nextKeyView");
while(_17d&&!objj_msgSend(_17d,"canBecomeKeyView")){
_17d=objj_msgSend(_17d,"nextKeyView");
}
return _17d;
}
...
}),new objj_method(sel_getUid("_setPreviousKeyView:"),function(self,_cmd,_185){
with(self){
...
var _c=_b.isa;
class_addMethods(_b,[new objj_method(sel_getUid("setLayer:"),function(self,_cmd,_18b){
with(self){
if(_layer==_18b){
return;
}
...
_layer=_18b;
if(_layer){
var _18c=CGRectMakeCopy(objj_msgSend(self,"bounds"));
...
}),new objj_method(sel_getUid("setWantsLayer:"),function(self,_cmd,_191){
with(self){
_wantsLayer=!!_191;
}
...
}),new objj_method(sel_getUid("hasThemeState:"),function(self,_cmd,_198){
with(self){
return !!(_themeState&((typeof _198==="string")?CPThemeState(_198):_198));
}
}),new objj_method(sel_getUid("setThemeState:"),function(self,_cmd,_19b){
with(self){
...
}),new objj_method(sel_getUid("unsetThemeState:"),function(self,_cmd,_19f){
with(self){
var _1a0=((typeof _19f==="string")?CPThemeState(_19f):_19f);
if(!(_themeState&_1a0)){
return NO;
}
_themeState&=~_1a0;
...
with(self){
var _1a3=objj_msgSend(self,"class"),_1a4=objj_msgSend(_1a3,"_themeAttributes"),_1a5=_1a4.length;
if(!_1a5){
return;
}
var _1a6=objj_msgSend(self,"theme"),_1a7=objj_msgSend(_1a3,"themeClass");
_themeAttributes={};
while(_1a5--){
var _1a8=_1a4[_1a5--],_1a9=objj_msgSend(objj_msgSend(_CPThemeAttribute,"alloc"),"initWithName:defaultValue:",_1a8,_1a4[_1a5]);
objj_msgSend(_1a9,"setParentAttribute:",objj_msgSend(_1a6,"_attributeWithName:forClass:",_1a8,_1a7));
_themeAttributes[_1a8]=_1a9;
}
}
}),new objj_method(sel_getUid("setTheme:"),function(self,_cmd,_1ac){
with(self){
if(_theme===_1ac){
return;
}
...
var _1b1=objj_msgSend(self,"theme"),_1b2=objj_msgSend(objj_msgSend(self,"class"),"themeClass");
for(var _1b3 in _themeAttributes){
if(_themeAttributes.hasOwnProperty(_1b3)){
objj_msgSend(_themeAttributes[_1b3],"setParentAttribute:",objj_msgSend(_1b1,"_attributeWithName:forClass:",_1b3,_1b2));
}
}
objj_msgSend(self,"setNeedsLayout");
objj_msgSend(self,"setNeedsDisplay:",YES);
...
with(self){
var _1b6=objj_msgSend(CPDictionary,"dictionary");
if(_themeAttributes){
var _1b7=objj_msgSend(self,"theme");
for(var _1b8 in _themeAttributes){
if(_themeAttributes.hasOwnProperty(_1b8)){
objj_msgSend(_1b6,"setObject:forKey:",_themeAttributes[_1b8],_1b8);
}
}
}
return _1b6;
}
}),new objj_method(sel_getUid("setValue:forThemeAttribute:inState:"),function(self,_cmd,_1bb,_1bc,_1bd){
with(self){
...
var _1be=objj_msgSend(self,"currentValueForThemeAttribute:",_1bc);
objj_msgSend(_themeAttributes[_1bc],"setValue:forState:",_1bb,_1bd);
if(objj_msgSend(self,"currentValueForThemeAttribute:",_1bc)===_1be){
return;
}
objj_msgSend(self,"setNeedsDisplay:",YES);
objj_msgSend(self,"setNeedsLayout");
}
}),new objj_method(sel_getUid("setValue:forThemeAttribute:"),function(self,_cmd,_1c1,_1c2){
with(self){
...
var _1c3=objj_msgSend(self,"currentValueForThemeAttribute:",_1c2);
objj_msgSend(_themeAttributes[_1c2],"setValue:",_1c1);
if(objj_msgSend(self,"currentValueForThemeAttribute:",_1c2)===_1c3){
return;
}
objj_msgSend(self,"setNeedsDisplay:",YES);
objj_msgSend(self,"setNeedsLayout");
}
}),new objj_method(sel_getUid("valueForThemeAttribute:inState:"),function(self,_cmd,_1c6,_1c7){
with(self){
...
return objj_msgSend(_themeAttributes[_1c6],"valueForState:",_1c7);
}
}),new objj_method(sel_getUid("valueForThemeAttribute:"),function(self,_cmd,_1ca){
with(self){
if(!_themeAttributes||!_themeAttributes[_1ca]){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,objj_msgSend(self,"className")+" does not contain theme attribute '"+_1ca+"'");
}
return objj_msgSend(_themeAttributes[_1ca],"value");
}
}),new objj_method(sel_getUid("currentValueForThemeAttribute:"),function(self,_cmd,_1cd){
with(self){
if(!_themeAttributes||!_themeAttributes[_1cd]){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,objj_msgSend(self,"className")+" does not contain theme attribute '"+_1cd+"'");
}
return objj_msgSend(_themeAttributes[_1cd],"valueForState:",_themeState);
}
}),new objj_method(sel_getUid("createEphemeralSubviewNamed:"),function(self,_cmd,_1d0){
with(self){
return nil;
}
}),new objj_method(sel_getUid("rectForEphemeralSubviewNamed:"),function(self,_cmd,_1d3){
with(self){
return {origin:{x:0,y:0},size:{width:0,height:0}};
}
}),new objj_method(sel_getUid("layoutEphemeralSubviewNamed:positioned:relativeToEphemeralSubviewNamed:"),function(self,_cmd,_1d6,_1d7,_1d8){
with(self){
if(!_ephemeralSubviewsForNames){
_ephemeralSubviewsForNames={};
_ephemeralSubviews=objj_msgSend(CPSet,"set");
}
var _1d9=objj_msgSend(self,"rectForEphemeralSubviewNamed:",_1d6);
if(_1d9&&!(_1d9.size.width<=0||_1d9.size.height<=0)){
if(!_ephemeralSubviewsForNames[_1d6]){
_ephemeralSubviewsForNames[_1d6]=objj_msgSend(self,"createEphemeralSubviewNamed:",_1d6);
objj_msgSend(_ephemeralSubviews,"addObject:",_ephemeralSubviewsForNames[_1d6]);
if(_ephemeralSubviewsForNames[_1d6]){
objj_msgSend(self,"addSubview:positioned:relativeTo:",_ephemeralSubviewsForNames[_1d6],_1d7,_ephemeralSubviewsForNames[_1d8]);
}
}
if(_ephemeralSubviewsForNames[_1d6]){
objj_msgSend(_ephemeralSubviewsForNames[_1d6],"setFrame:",_1d9);
}
}else{
if(_ephemeralSubviewsForNames[_1d6]){
objj_msgSend(_ephemeralSubviewsForNames[_1d6],"removeFromSuperview");
objj_msgSend(_ephemeralSubviews,"removeObject:",_ephemeralSubviewsForNames[_1d6]);
delete _ephemeralSubviewsForNames[_1d6];
}
}
return _ephemeralSubviewsForNames[_1d6];
}
})]);
...
var _1e0=objj_msgSend(self,"class"),_1e1=objj_msgSend(CPView,"class"),_1e2=[];
for(;_1e0&&_1e0!==_1e1;_1e0=objj_msgSend(_1e0,"superclass")){
var _1e3=_2[class_getName(_1e0)];
if(_1e3){
_1e2=_1e2.length?_1e2.concat(_1e3):_1e2;
_2[objj_msgSend(self,"className")]=_1e2;
break;
}
var _1e4=objj_msgSend(_1e0,"themeAttributes");
if(!_1e4){
continue;
}
var _1e5=objj_msgSend(_1e4,"allKeys"),_1e6=_1e5.length;
while(_1e6--){
var _1e7=_1e5[_1e6];
_1e2.push(objj_msgSend(_1e4,"objectForKey:",_1e7));
_1e2.push(_1e7);
}
}
return _1e2;
...
var _1e8="CPViewAutoresizingMask",_1e9="CPViewAutoresizesSubviews",_1ea="CPViewBackgroundColor",_1eb="CPViewBoundsKey",_1ec="CPViewFrameKey",_1ed="CPViewHitTestsKey",_1ee="CPViewIsHiddenKey",_1ef="CPViewOpacityKey",_1f0="CPViewSubviewsKey",_1f1="CPViewSuperviewKey",_1f2="CPViewTagKey",_1f3="CPViewThemeStateKey",_1f4="CPViewWindowKey",_1f5="CPViewNextKeyViewKey",_1f6="CPViewPreviousKeyViewKey";
var _b=objj_getClass("CPView");
if(!_b){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPView\""));
}
var _c=_b.isa;
class_addMethods(_b,[new objj_method(sel_getUid("initWithCoder:"),function(self,_cmd,_1f9){
with(self){
_DOMElement=_3.cloneNode(false);
_frame=objj_msgSend(_1f9,"decodeRectForKey:",_1ec);
_bounds=objj_msgSend(_1f9,"decodeRectForKey:",_1eb);
self=objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPResponder")},"initWithCoder:",_1f9);
if(self){
_tag=objj_msgSend(_1f9,"containsValueForKey:",_1f2)?objj_msgSend(_1f9,"decodeIntForKey:",_1f2):-1;
_window=objj_msgSend(_1f9,"decodeObjectForKey:",_1f4);
_subviews=objj_msgSend(_1f9,"decodeObjectForKey:",_1f0)||[];
_superview=objj_msgSend(_1f9,"decodeObjectForKey:",_1f1);
_registeredDraggedTypes=objj_msgSend(CPSet,"set");
_registeredDraggedTypesArray=[];
_autoresizingMask=objj_msgSend(_1f9,"decodeIntForKey:",_1e8)||CPViewNotSizable;
_autoresizesSubviews=!objj_msgSend(_1f9,"containsValueForKey:",_1e9)||objj_msgSend(_1f9,"decodeBoolForKey:",_1e9);
_hitTests=!objj_msgSend(_1f9,"containsValueForKey:",_1ed)||objj_msgSend(_1f9,"decodeObjectForKey:",_1ed);
_DOMImageParts=[];
_DOMImageSizes=[];
if(NULL){
var _1fa={x:CGPointMake((_frame.origin.x),(_frame.origin.y)).x*NULL.a+CGPointMake((_frame.origin.x),(_frame.origin.y)).y*NULL.c+NULL.tx,y:CGPointMake((_frame.origin.x),(_frame.origin.y)).x*NULL.b+CGPointMake((_frame.origin.x),(_frame.origin.y)).y*NULL.d+NULL.ty};
}else{
var _1fa={x:(_frame.origin.x),y:(_frame.origin.y)};
}
_DOMElement.style.left=ROUND(_1fa.x)+"px";
_DOMElement.style.top=ROUND(_1fa.y)+"px";
_DOMElement.style.width=MAX(0,ROUND((_frame.size.width)))+"px";
_DOMElement.style.height=MAX(0,ROUND((_frame.size.height)))+"px";
var _1fb=0,_1fc=_subviews.length;
for(;_1fb<_1fc;++_1fb){
_DOMElement.appendChild(_subviews[_1fb]._DOMElement);
}
if(objj_msgSend(_1f9,"containsValueForKey:",_1ee)){
objj_msgSend(self,"setHidden:",objj_msgSend(_1f9,"decodeBoolForKey:",_1ee));
}else{
_isHidden=NO;
}
if(objj_msgSend(_1f9,"containsValueForKey:",_1ef)){
objj_msgSend(self,"setAlphaValue:",objj_msgSend(_1f9,"decodeIntForKey:",_1ef));
}else{
_opacity=1;
}
objj_msgSend(self,"setBackgroundColor:",objj_msgSend(_1f9,"decodeObjectForKey:",_1ea));
objj_msgSend(self,"setupViewFlags");
_theme=objj_msgSend(CPTheme,"defaultTheme");
_themeState=CPThemeState(objj_msgSend(_1f9,"decodeIntForKey:",_1f3));
_themeAttributes={};
var _1fd=objj_msgSend(self,"class"),_1fe=objj_msgSend(_1fd,"themeClass"),_1ff=objj_msgSend(_1fd,"_themeAttributes"),_1fc=_1ff.length;
while(_1fc--){
var _200=_1ff[_1fc--];
_themeAttributes[_200]=CPThemeAttributeDecode(_1f9,_200,_1ff[_1fc],_theme,_1fe);
}
objj_msgSend(self,"setNeedsDisplay:",YES);
objj_msgSend(self,"setNeedsLayout");
}
...
}),new objj_method(sel_getUid("encodeWithCoder:"),function(self,_cmd,_203){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPResponder")},"encodeWithCoder:",_203);
if(_tag!==-1){
objj_msgSend(_203,"encodeInt:forKey:",_tag,_1f2);
}
objj_msgSend(_203,"encodeRect:forKey:",_frame,_1ec);
objj_msgSend(_203,"encodeRect:forKey:",_bounds,_1eb);
if(_window!==nil){
objj_msgSend(_203,"encodeConditionalObject:forKey:",_window,_1f4);
}
var _204=objj_msgSend(_subviews,"count"),_205=_subviews;
if(_204>0&&objj_msgSend(_ephemeralSubviews,"count")>0){
_205=objj_msgSend(_205,"copy");
while(_204--){
if(objj_msgSend(_ephemeralSubviews,"containsObject:",_205[_204])){
_205.splice(_204,1);
}
}
}
if(_205.length>0){
objj_msgSend(_203,"encodeObject:forKey:",_205,_1f0);
}
if(_superview!==nil){
objj_msgSend(_203,"encodeConditionalObject:forKey:",_superview,_1f1);
}
if(_autoresizingMask!==CPViewNotSizable){
objj_msgSend(_203,"encodeInt:forKey:",_autoresizingMask,_1e8);
}
if(!_autoresizesSubviews){
objj_msgSend(_203,"encodeBool:forKey:",_autoresizesSubviews,_1e9);
}
if(_backgroundColor!==nil){
objj_msgSend(_203,"encodeObject:forKey:",_backgroundColor,_1ea);
}
if(_hitTests!==YES){
objj_msgSend(_203,"encodeBool:forKey:",_hitTests,_1ed);
}
if(_opacity!==1){
objj_msgSend(_203,"encodeFloat:forKey:",_opacity,_1ef);
}
if(_isHidden){
objj_msgSend(_203,"encodeBool:forKey:",_isHidden,_1ee);
}
var _206=objj_msgSend(self,"nextKeyView");
if(_206!==nil){
objj_msgSend(_203,"encodeConditionalObject:forKey:",_206,_1f5);
}
var _207=objj_msgSend(self,"previousKeyView");
if(_207!==nil){
objj_msgSend(_203,"encodeConditionalObject:forKey:",_207,_1f6);
}
objj_msgSend(_203,"encodeInt:forKey:",CPThemeStateName(_themeState),_1f3);
for(var _208 in _themeAttributes){
if(_themeAttributes.hasOwnProperty(_208)){
CPThemeAttributeEncode(_203,_themeAttributes[_208]);
}
}
}
})]);
var _a8=function(_209){
var _20a=_209._superview;
return {autoresizingMask:_209._autoresizingMask,frame:CGRectMakeCopy(_209._frame),index:(_20a?objj_msgSend(_20a._subviews,"indexOfObjectIdenticalTo:",_209):0),superview:_20a};
};
var _e7=function(_20b,_20c){
var _20d=CGAffineTransformMakeIdentity(),_20e=YES,_20f=nil,_210=nil;
if(_20b){
var view=_20b;
while(view&&view!=_20c){
var _212=view._frame;
_20d.tx+=(_212.origin.x);
_20d.ty+=(_212.origin.y);
if(view._boundsTransform){
var tx=_20d.tx*view._boundsTransform.a+_20d.ty*view._boundsTransform.c+view._boundsTransform.tx;
_20d.ty=_20d.tx*view._boundsTransform.b+_20d.ty*view._boundsTransform.d+view._boundsTransform.ty;
_20d.tx=tx;
var a=_20d.a*view._boundsTransform.a+_20d.b*view._boundsTransform.c,b=_20d.a*view._boundsTransform.b+_20d.b*view._boundsTransform.d,c=_20d.c*view._boundsTransform.a+_20d.d*view._boundsTransform.c;
_20d.d=_20d.c*view._boundsTransform.b+_20d.d*view._boundsTransform.d;
_20d.a=a;
_20d.b=b;
_20d.c=c;
}
...
if(_20b&&_20c){
_20f=objj_msgSend(_20b,"window");
_210=objj_msgSend(_20c,"window");
if(_20f&&_210&&_20f!==_210){
_20e=NO;
var _212=objj_msgSend(_20f,"frame");
_20d.tx+=(_212.origin.x);
_20d.ty+=(_212.origin.y);
}
}
...
_20d.ty-=(_212.origin.y);
if(view._boundsTransform){
var tx=_20d.tx*view._inverseBoundsTransform.a+_20d.ty*view._inverseBoundsTransform.c+view._inverseBoundsTransform.tx;
_20d.ty=_20d.tx*view._inverseBoundsTransform.b+_20d.ty*view._inverseBoundsTransform.d+view._inverseBoundsTransform.ty;
_20d.tx=tx;
var a=_20d.a*view._inverseBoundsTransform.a+_20d.b*view._inverseBoundsTransform.c,b=_20d.a*view._inverseBoundsTransform.b+_20d.b*view._inverseBoundsTransform.d,c=_20d.c*view._inverseBoundsTransform.a+_20d.d*view._inverseBoundsTransform.c;
_20d.d=_20d.c*view._inverseBoundsTransform.b+_20d.d*view._inverseBoundsTransform.d;
_20d.a=a;
_20d.b=b;
_20d.c=c;
}
...
if(!_20e){
var _212=objj_msgSend(_210,"frame");
_20d.tx-=(_212.origin.x);
_20d.ty-=(_212.origin.y);
}
return _20d;
