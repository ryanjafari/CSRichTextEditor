I;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;13;CPResponder.ji;10;CPWindow.ji;12;CPDocument.jc;13779;
...
{ with(self)
{
    objj_msgSend(self, "_synchronizeDocumentEditedState");
}
},["void","BOOL"]), new objj_method(sel_getUid("_synchronizeDocumentEditedState"), function $CPWindowController___synchronizeDocumentEditedState(self, _cmd)
{ with(self)
{
    var docs = objj_msgSend(self, "documents"),
        count = objj_msgSend(docs, "count"),
        isEdited = NO;
    while (count--)
    {
        if (objj_msgSend(docs[count], "isDocumentEdited"))
        {
            isEdited = YES;
            break;
        }
...
},["void"]), new objj_method(sel_getUid("close"), function $CPWindowController__close(self, _cmd)
{ with(self)
{
