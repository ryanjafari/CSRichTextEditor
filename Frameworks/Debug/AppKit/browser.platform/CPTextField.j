i;11;CPControl.ji;17;CPStringDrawing.ji;17;CPCompatibility.jc;35528;
        ...
        CPTextFieldKeyPressFunction = function(aDOMEvent)
        {
            ...
            if (aDOMEvent.keyCode == CPReturnKeyCode || aDOMEvent.keyCode == CPTabKeyCode)
            {
                ...
                if (aDOMEvent && aDOMEvent.keyCode == CPReturnKeyCode)
                {
                    ...
                    {
                        owner._isEditing = NO;
                        objj_msgSend(owner, "textDidEndEditing:", objj_msgSend(CPNotification, "notificationWithName:object:userInfo:", CPControlTextDidEndEditingNotification, owner, nil));
                    }
                    objj_msgSend(owner, "sendAction:to:", objj_msgSend(owner, "action"), objj_msgSend(owner, "target"));
                    objj_msgSend(owner, "selectText:", nil);
                }
        ...
        CPTextFieldKeyUpFunction = function()
        {
            ...
            if (objj_msgSend(CPTextFieldInputOwner, "stringValue") !== CPTextFieldTextDidChangeValue)
            {
                if (!CPTextFieldInputOwner._isEditing)
                {
                    ...
                    objj_msgSend(CPTextFieldInputOwner, "textDidBeginEditing:", objj_msgSend(CPNotification, "notificationWithName:object:userInfo:", CPControlTextDidBeginEditingNotification, CPTextFieldInputOwner, nil));
                }
...
},["BOOL"]), new objj_method(sel_getUid("textDidBlur:"), function $CPTextField__textDidBlur_(self, _cmd, note)
{ with(self)
{
...
},["void","CPNotification"]), new objj_method(sel_getUid("mouseDown:"), function $CPTextField__mouseDown_(self, _cmd, anEvent)
{ with(self)
{
