I;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;12;CPGeometry.ji;19;CPGraphicsContext.ji;13;CPResponder.ji;9;CPTheme.ji;18;_CPDisplayServer.jc;62719;
CPViewNotSizable = 0;
CPViewMinXMargin = 1;
...
{ with(self)
{
    ...
    while (count--)
        if (objj_msgSend(subviews[count], "performKeyEquivalent:", anEvent))
            return YES;
    return NO;
}
